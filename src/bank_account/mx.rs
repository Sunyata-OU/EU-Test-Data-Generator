...
static BANK_CODES: &[u16] = &[
    2, 6, 9, 12, 14, 19, 21, 22, 30, 32, 36, 37, 42, 44, 58, 59, 60, 62, 72, 102, 103, 106, 108,
    110, 112, 113, 116, 124, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139,
    140, 141, 143, 145, 147, 148, 150, 151, 152, 154, 155, 156, 157, 158, 159, 160, 166, 167, 168,
];

/// Representative city codes (plaza codes) covering all Mexican states.
static CITY_CODES: &[u16] = &[
    10, 12, 14, 20, 22, 24, 40, 42, 44, 50, 52, 54, 56, 60, 62, 64, 66, 68, 70, 72, 74, 76, 78, 80,
    90, 92, 94, 96, 100, 102, 104, 106, 110, 120, 130, 140, 150, 152, 154, 160, 170, 180, 190, 192,
    194, 200, 210, 212, 214, 220, 230, 240, 260, 270, 280, 290, 300, 310, 320, 330, 340, 350, 360,
